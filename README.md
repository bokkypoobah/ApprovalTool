...
* This tool scans for [ERC-20](https://eips.ethereum.org/EIPS/eip-20), [ERC-721](https://eips.ethereum.org/EIPS/eip-721) and [ERC-1155](https://eips.ethereum.org/EIPS/eip-1155) *Approval* and *ApprovalForAll* log events from the owner's account. This is done using the `getFilter(...)` web3 call.
